...
const Analytics = () => {
  ...
  const [statsData, setStatsData] = useState(demoData);
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">
                  {(statsData.currentPeriod.sales / statsData.productSales.reduce((acc, curr) => acc + curr.quantity, 0)).toLocaleString()} ₽
                </span>
              </div>
            </div>
          </Card>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    label
                  >
                    {statsData.productSales.map((_, index) => (
