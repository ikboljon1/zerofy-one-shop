            ...
            <Card className="bg-white/80 backdrop-blur col-span-2">
              ...
              <CardContent>
                ...
                <div className="mt-4 h-32 w-full flex items-end justify-between space-x-2">
                  {[35, 42, 38, 54, 48, 62, 58, 70, 65, 75, 78, 82].map((height, i) => <div key={i} className="flex-1 flex flex-col items-center">
                      <div className="w-full flex space-x-[2px]">
                        <div className="flex-1 bg-blue-200" style={{
                      height: `${height * 0.5}px`
                    }} />
                        <div className="flex-1 bg-blue-400" style={{
                      height: `${height * 0.8}px`
                    }} />
                        <div className="flex-1 bg-blue-600" style={{
                      height: `${height}px`
                    }} />
                      </div>
              ...
              <CardContent>
                <div className="relative p-4">
                  <div className="h-40 w-40 mx-auto relative">
                    ...
                    <div className="absolute inset-0 rounded-full bg-violet-200" style={{
                    clipPath: 'polygon(50% 50%, 100% 0, 100% 100%)'
                  }}></div>
                    <div className="absolute inset-0 rounded-full bg-violet-300" style={{
                    clipPath: 'polygon(50% 50%, 0 0, 100% 0)'
                  }}></div>
                    <div className="absolute inset-0 rounded-full bg-violet-400" style={{
