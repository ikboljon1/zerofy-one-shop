...
import { useWarehouse, WarehouseProvider } from '@/contexts/WarehouseContext';
...
// Оборачиваем компонент в поставщик контекста
