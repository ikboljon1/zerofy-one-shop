...
import { useWarehouse, useLoadWarehouseData } from '@/contexts/WarehouseContext';
...
const Warehouses: React.FC = () => {
  ...
  const loadWarehouseData = useLoadWarehouseData();
  ...
  useEffect(() => {
    if (selectedStore) {
      loadWarehouseData(selectedStore);
    }
  }, [activeTab, selectedStore, loadWarehouseData]);
  ...
  const handleRefreshData = () => {
    ...
    refreshData(activeTab, selectedStore.apiKey);
  };
                  ...
                  {loading.coefficients ? (
                    ...
                    <WarehouseCoefficientsDateCard
                      ...
                      onSavePreferred={(warehouseId) => {
                        if (selectedStore) {
                          handleSavePreferredWarehouse(warehouseId, selectedStore.id);
                        }
                      }}
            ...
            <>
              ...
              {loading.paidStorage && paidStorageData.length === 0 ? (
                ...
                <PaidStorageCostReport 
                  ...
                  onRefresh={() => {
                    if (selectedStore) {
                      refreshData('storage', selectedStore.apiKey);
                    }
                  }}
                />
              )}
