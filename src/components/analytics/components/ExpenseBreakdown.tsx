  ...
  return (
    <Card className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
        ...
        <div className="flex flex-col mt-0 p-3 bg-gradient-to-br from-gray-50 to-white dark:from-gray-950/20 dark:to-background border border-gray-200 dark:border-gray-800 rounded-lg">
          <div className="flex justify-between items-center">
            <h4 className="text-sm font-medium">Общие удержания (включая возвраты)</h4>
