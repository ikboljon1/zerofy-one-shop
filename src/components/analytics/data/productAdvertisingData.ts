...
// Default product advertising data for initialization when API data is not available
export const getDefaultProductAdvertisingData = () => {
  return [
    {
      name: "1124-спандекс-коричневый",
      value: 7500,
      color: "#8b5cf6",
      id: 288457437
    },
    {
      name: "2401-спандекс-графит",
      value: 5200,
      color: "#ec4899",
      id: 274427525
    },
    {
      name: "платье-лапша-001",
      value: 3800,
      color: "#f59e0b",
      id: 269473500
    },
...
// Default returns data for initialization when API data is not available
export const getDefaultReturnsData = () => {
  return [
    {
      name: "1124-спандекс-коричневый",
      value: 44911.23,
