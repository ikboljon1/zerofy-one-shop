...
const OrdersChart: React.FC<OrdersChartProps> = React.memo(({ orders, sales }) => {
  ...
  // Add top selling products logic
  ...
  return (
    ...
    >
      ...
      <motion.div variants={chartVariants} className="h-full">
        <Card className="overflow-hidden border-0 shadow-xl bg-gradient-to-br from-white to-amber-50/40 dark:from-gray-900 dark:to-amber-950/30 h-full">
      ...
      <motion.div variants={chartVariants} className="h-full lg:col-span-2">
